...
import com.ihandy.wyreader.utils.ThemeUtils;
import com.ihandy.wyreader.widget.CircleHeader;
...
//		startService(new Intent(getAppContext(), BookDownloadService.class));
	...
	private void initRefresh() {
		SmartRefreshLayout.setDefaultRefreshHeaderCreater((context, layout) -> {
			...
			RefreshLayout refreshLayout = layout.setPrimaryColorsId(ThemeUtils.getThemeColorId(), R.color.white);
			return header;
		});
...
//                .setSslSocketFactory()
	...
	private void initLoadingLayout() {
		LoadingLayout.getConfig()
				...
				.setAllTipTextColor(R.color.base_loading_background)
