...
public class ScreenUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = WYApplication.getAppContext().getResources();
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs = WYApplication.getAppContext().getResources();
    ...
    public static DisplayMetrics getDisplayMetrics() {
        DisplayMetrics metrics = WYApplication.getAppContext()
                .getResources()
                .getDisplayMetrics();
        return metrics;
    }
